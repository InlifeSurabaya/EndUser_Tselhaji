...
<div
    ...
    <div class="px-6">
        <a class="flex-none text-xl font-semibold text-white" href="{{ route('admin.dashboard') }}" wire:navigate
           aria-label="Brand">
            MyTelkomsel Admin
        </a>
    </div>
    ...
    <nav class="p-6 flex flex-col gap-y-1 text-sm text-neutral-400">
        ...
        <a href="{{ route('admin.manajemen-pesanan') }}"
           wire:navigate
           class="flex items-center gap-x-3.5 py-2 px-2.5 rounded-lg transition
                {{ Route::is('admin.manajemen-pesanan') ? 'bg-[var(--color-primary-600)] text-white' : 'hover:bg-neutral-800 hover:text-white' }}">
            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        {{-- manajmene harga spesial --}}
        <a href="{{ route('admin.manajemen-harga-spesial') }}"
           wire:navigate
           class="flex items-center gap-x-3.5 py-2 px-2.5 rounded-lg transition
                {{ Route::is('admin.manajemen-harga-spesial') ? 'bg-[var(--color-primary-600)] text-white' : 'hover:bg-neutral-800 hover:text-white' }}">
            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/>
                <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/>
            </svg>
            Manajemen Harga Spesial
        </a>
