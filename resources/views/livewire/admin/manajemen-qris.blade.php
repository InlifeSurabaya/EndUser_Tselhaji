<div @clear-file-input.window="document.getElementById('qris-upload').value = null"
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-neutral-600">Perbarui atau unggah gambar QRIS statis yang akan ditampilkan di halaman
            pembayaran.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white border border-neutral-200 rounded-lg shadow-sm p-5">
                ...
                @if ($currentQris)
                    <div class="space-y-3">
                        <img src="{{ asset('storage/' . $currentQris->file) }}" alt="QRIS Aktif"
                ...
                @else
                    <div
                        class="flex items-center justify-center h-48 border-2 border-dashed border-neutral-300 rounded-md bg-neutral-50">
                    ...
                    <div>
                        ...
                        @if ($newQris)
                            <div class="relative group">
                                <img src="{{ $newQris->temporaryUrl() }}" alt="Preview QRIS"
                                     class="w-full max-w-sm mx-auto rounded-md border border-neutral-300">
                                <button wire:click="clearPreview" type="button"
                                        class="absolute top-2 right-2 bg-neutral-800 bg-opacity-50 text-white rounded-full p-1.5 opacity-0 group-hover:opacity-100 transition-opacity"
                                ...
                                <div wire:loading wire:target="newQris"
                        ...
                        @else
                            <label for="qris-upload"
                                   class="relative flex flex-col items-center justify-center w-full h-64 border-2 border-neutral-300 border-dashed rounded-lg cursor-pointer bg-neutral-50 hover:bg-neutral-100 transition-colors">
                                <div class="text-center">
                                    <svg class="mx-auto h-12 w-12 text-neutral-400" xmlns="http://www.w3.org/2000/svg"
                                         fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5"/>
                                    </svg>
                                    <p class="mt-2 text-sm text-neutral-600">
                                        <span class="font-semibold text-accent-600">Klik untuk memilih</span>
